...
#define CYBLE_ACCELEROMETER__SERVICE_INDEX   (0x00u) /* Index of Accelerometer  service in the cyBle_customs array */
#define CYBLE_ACCELEROMETER__ACC_CHAR_INDEX   (0x00u) /* Index of ACC characteristic */
#define CYBLE_ACCELEROMETER__ACC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_ACCELEROMETER__ACC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */

#define CYBLE_ADC_SERVICE_INDEX   (0x01u) /* Index of ADC service in the cyBle_customs array */
#define CYBLE_ADC_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CYBLE_ADC_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */


#define CYBLE_ACCELEROMETER__SERVICE_HANDLE   (0x0010u) /* Handle of Accelerometer  service */
#define CYBLE_ACCELEROMETER__ACC_DECL_HANDLE   (0x0011u) /* Handle of ACC characteristic declaration */
#define CYBLE_ACCELEROMETER__ACC_CHAR_HANDLE   (0x0012u) /* Handle of ACC characteristic */
#define CYBLE_ACCELEROMETER__ACC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_ACCELEROMETER__ACC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0014u) /* Handle of Client Characteristic Configuration descriptor */

#define CYBLE_ADC_SERVICE_HANDLE   (0x0015u) /* Handle of ADC service */
#define CYBLE_ADC_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0016u) /* Handle of Custom Characteristic characteristic declaration */
#define CYBLE_ADC_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0017u) /* Handle of Custom Characteristic characteristic */
#define CYBLE_ADC_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0018u) /* Handle of Custom Descriptor descriptor */
