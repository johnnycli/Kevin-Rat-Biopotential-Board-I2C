...
***************************************/
    ...
    *
    * \globalvars
    *  UART_OUT_rxBufferHead - the start index to put data into the 
    *  software receive buffer.
    *  UART_OUT_rxBufferTail - the start index to get data from the 
    *  software receive buffer.
    *
    *******************************************************************************/
    ...
    *
    * \globalvars
    *  UART_OUT_txBufferHead - the start index to put data into the 
    *  software transmit buffer.
    *  UART_OUT_txBufferTail - start index to get data from the software
    *  transmit buffer.
    *
    *******************************************************************************/
